...
//  CNLabel.m
//
//  Extension of UILabel that automatically finds the correct height to word wrap its contents, allows animation on
//  any text changes and allows for temporary messages while storing a persistent string to revert to.
//
